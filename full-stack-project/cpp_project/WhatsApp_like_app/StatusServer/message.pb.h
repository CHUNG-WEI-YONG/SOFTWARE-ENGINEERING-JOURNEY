...
inline ::int32_t AddFriendMsg::status() const {
  // @@protoc_insertion_point(field_get:message.AddFriendMsg.status)
  return _internal_status();
}
inline void AddFriendMsg::set_status(::int32_t value) {
  _internal_set_status(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000020U);
  // @@protoc_insertion_point(field_set:message.AddFriendMsg.status)
}
inline ::int32_t AddFriendMsg::_internal_status() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.status_;
}
inline void AddFriendMsg::_internal_set_status(::int32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
